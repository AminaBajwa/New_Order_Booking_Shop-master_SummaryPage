...
class DBHelperOrderMaster{
  ...
  _onCreate(Database db, int version) {
    db.execute(
        "CREATE TABLE orderMaster (orderId INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date TEXT, shopName TEXT, ownerName TEXT, phoneNo TEXT, brand TEXT, userId TEXT)");
  }
